...
- [x] **Step 1: 写失败测试 — 验证 free tier 种子数据存在**
...
- [x] **Step 3: 实现最小变更 — 在 `_initialTiers` 数组中新增两条记录**
...
- [x] **Step 5: 修复 resetMonthlyUsage 测试中的计数断言**
...
- [x] **Step 6: 再次运行全部 apiTierStore 测试**
...
- [x] **Step 1: 写失败测试 — 验证新 tenant 可被查询到**
...
- [x] **Step 3: 在 seed.js 中新增 tenant_a002**
...
- [x] **Step 4: 在 seed.js 末尾新增 tenant_008**
...
- [x] **Step 5: 更新 tenantStore 测试中的 total 计数**
...
- [x] **Step 6: 运行全部 tenantStore 测试**

Run: `cd Mobile && node --test backend/test/tenantStore.test.js`
Expected: 全部 PASS

- [x] **Step 7: 运行全量后端测试确认无回归**
...
- [x] **Step 1: 写失败测试 — 验证 tenant_008 有 seed API Key**
...
- [x] **Step 3: 在 apiKeyStore 的 reset() 中添加 seed key**
