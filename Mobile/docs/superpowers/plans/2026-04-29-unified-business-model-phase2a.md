...
- [ ] **Step 2: 修改 auth.js TOKEN_MAP，并预留动态 mock 用户注册能力**
...
- [ ] **Step 11: 添加登录页 token 输入 escape hatch**
...
- [ ] **Step 1: 新增辅助方法到 apply_mock_shaping.dart**
...
- [ ] **Step 4: 修改 AlertsController 接入 shaping**
...
- [ ] **Step 5: 修改 FenceController 接入 shaping**
...
- [ ] **Step 6: 修改 DashboardController 接入 shaping**
...
- [ ] **Step 7: 修改 StatsController 接入 shaping**
