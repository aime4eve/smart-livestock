...
class AlertCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        // IntrinsicHeight bounds the stretch Row to content height; without it
        // unbounded list viewports pass h=Infinity and layout asserts.
  ...
  Color _iconBgColor(AlertItem alert, bool isResolved) {
    ...
    return switch (alert.type) {
      ...
      'DIGESTIVE_ABNORMAL' ||
      'DEVICE_LOW_BATTERY' ||
      'DEVICE_TAMPER' => AppColors.warning.withValues(alpha: 0.1),
  ...
  Color _iconColor(AlertItem alert, bool isResolved) {
    ...
    return switch (alert.type) {
      ...
      'DIGESTIVE_ABNORMAL' ||
      'DEVICE_LOW_BATTERY' ||
      'DEVICE_TAMPER' => AppColors.warning,
  ...
  String _formatTime(AppLocalizations l10n, String iso) {
    try {
      ...
      if (diff.inDays < 2) {
        return l10n.alertYesterdayTime(
...
class _SourceTag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        label,
        style: TextStyle(fontSize: 7, fontWeight: FontWeight.w700, color: fg),
      ),
    );
  }
}
