...
class FeverWarningPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('发热预警'), backgroundColor: AppColors.primary, foregroundColor: Colors.white),
      body: asyncList.when(
        ...
        data: (items) {
          if (items.isEmpty) {
            return const Center(child: Text('暂无体温异常数据', style: TextStyle(fontSize: 16)));
          }
