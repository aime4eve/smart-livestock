...
- **次级佐证（强度有限，2026-09-10 修正）**：论文判定反刍的特征是 ICI ≈ 40–50 秒 → 换算 1.2–1.5 次/分，与文献「瘤胃蠕动 1–3 次/分」**量级相容、不矛盾**。注意不能称"吻合/验证"：①子区间落入母区间≠验证；②ICI 是反刍期行为（收缩偏慢），临床 1–3 次/分是触诊口径，两者生理口径不同；③40–50s 是作者为分类挑的粗窗口（postulated），非频率统计分布。阈值护栏 max(0.5×baseline, 1.0) 的下限依据仍以临床教材为主
