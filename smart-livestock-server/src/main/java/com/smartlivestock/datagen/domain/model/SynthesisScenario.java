...
/**
 * Aggregate root: defines which livestock get what anomaly injected over what time window.
 * Replaces TelemetrySimulator random boolean flags with configurable, persistent scenarios.
 */
public class SynthesisScenario extends AggregateRoot {
    private String name;
    private ScenarioStatus status;
    private AnomalyPattern pattern;
    private double penetrationRate;       // 0.0-1.0, fraction of target livestock to inject
